...
TEST(positive_tests, test1)
{
    ...
    big_int bigint_1("2");
    big_int bigint_2("3");
    bigint_1.divide_assign(bigint_2, big_int::division_rule::Newton);
...
TEST(positive_tests, test2)
{
    ...
    EXPECT_THROW(bigint_1.divide_assign(bigint_2, big_int::division_rule::Newton), std::logic_error);
...
TEST(positive_tests, test5)
{
    ...
    big_int result_of_division = bigint_1.divide_assign(bigint_2, big_int::division_rule::Newton);
