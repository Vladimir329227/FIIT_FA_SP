...
TEST(bTreePositiveTests, test0)
{
    ...
    BSP_tree<int, std::string, std::less<int>, 1024> tree(std::less<int>(), nullptr, logger.get());
...
TEST(bTreePositiveTests, test1)
{
    ...
    BSP_tree<int, std::string, std::less<int>, 3> tree(std::less<int>(), nullptr, logger.get());
...
TEST(bTreePositiveTests, test2)
{
    ...
    BSP_tree<int, std::string, std::less<int>, 5> tree(std::less<int>(), nullptr, logger.get());
...
TEST(bTreePositiveTests, test3)
{
    ...
    BSP_tree<int, std::string, std::less<int>, 7> tree(std::less<int>(), nullptr, logger.get());
...
TEST(bTreePositiveTests, test5)
{
    ...
    BSP_tree<int, std::string, std::less<int>, 2> tree(std::less<int>(), nullptr, logger.get());
...
TEST(bTreePositiveTests, test6)
{
    ...
    BSP_tree<int, std::string, std::less<int>, 4> tree(std::less<int>(), nullptr, logger.get());
